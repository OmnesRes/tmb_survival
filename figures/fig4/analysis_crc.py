...
##all data
print('all data')
df = pickle.load(open(cwd / 'figures' / 'fig4' / 'crc_sample_table.pkl', 'rb'))
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'fig4' / ('crc_all.pkl'), 'rb'))
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'fig4' / ('crc_io.pkl'), 'rb'))
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'fig4' / ('crc_nonio.pkl'), 'rb'))
