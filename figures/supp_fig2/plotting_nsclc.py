...
##io data
df = pickle.load(open(cwd / 'figures' / 'supp_fig1' / 'nsclc_sample_table.pkl', 'rb'))
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig1' / ('nsclc_io.pkl'), 'rb'))
...
plt.savefig(cwd / 'figures' / 'supp_fig1' / 'nsclc_io_data.pdf')
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig1' / ('nsclc_nonio.pkl'), 'rb'))
indexes = np.argsort(tmb)
...
plt.legend(frameon=False, loc='upper center', ncol=4)
plt.savefig(cwd / 'figures' / 'supp_fig1' / 'nsclc_nonio_data.pdf')