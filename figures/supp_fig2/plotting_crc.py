...
##io data
df = pickle.load(open(cwd / 'figures' / 'supp_fig1' / 'crc_sample_table.pkl', 'rb'))
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig1' / ('crc_nonio.pkl'), 'rb'))
...
plt.savefig(cwd / 'figures' / 'supp_fig1' / 'crc_nonio_data.pdf')