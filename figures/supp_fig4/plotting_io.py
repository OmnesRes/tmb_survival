...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig4' / 'SKCM_io.pkl', 'rb'))
...
plt.savefig(cwd / 'figures' / 'supp_fig4' / 'melanoma_io.pdf')
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig4' / 'NSCLC_io.pkl', 'rb'))
indexes = np.argsort(tmb)
...
plt.legend(frameon=False, loc='upper center', ncol=4)
plt.savefig(cwd / 'figures' / 'supp_fig4' / 'nsclc_io_2019.pdf')
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig4' / 'NSCLC_io_cohort2.pkl', 'rb'))
indexes = np.argsort(tmb)
...
plt.legend(frameon=False, loc='upper center', ncol=4)
plt.savefig(cwd / 'figures' / 'supp_fig4' / 'nsclc_io_2021.pdf')
