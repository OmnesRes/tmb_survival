...
single_cutoff = pickle.load(open(cwd / 'figures' / 'supp_fig4' / 'single_cutoff_step.pkl', 'rb'))
tmb, sim_risks, times_events = pickle.load(open(cwd / 'figures' / 'supp_fig4' / 'step_data.pkl', 'rb'))
...
plt.savefig(cwd / 'figures' / 'supp_fig4' / 'step_single.pdf')
