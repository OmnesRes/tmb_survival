...
test_idx, results = pickle.load(open(cwd / 'figures' / 'msk_figure' / 'SKCM_io.pkl', 'rb'))
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'msk_figure' / 'NSCLC_io.pkl', 'rb'))
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'msk_figure' / 'NSCLC_io_cohort2.pkl', 'rb'))
