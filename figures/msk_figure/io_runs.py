...
# with open(cwd / 'figures' / 'msk_figure' / 'SKCM_io.pkl', 'wb') as f:
...
# with open(cwd / 'figures' / 'msk_figure' / 'NSCLC_io.pkl', 'wb') as f:
#     pickle.dump([test_idx, results], f)
...
with open(cwd / 'figures' / 'msk_figure' / 'NSCLC_io_cohort2.pkl', 'wb') as f:
    pickle.dump([test_idx, results], f)
