...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig3' / 'SKCM_io.pkl', 'rb'))
...
plt.legend(frameon=False, loc='upper center', ncol=4)
plt.savefig(cwd / 'figures' / 'supp_fig3' / 'nsclc_io_2019.pdf')
...
test_idx, results = pickle.load(open(cwd / 'figures' / 'supp_fig3' / 'NSCLC_io_cohort2.pkl', 'rb'))
indexes = np.argsort(tmb)
...
plt.legend(frameon=False, loc='upper center', ncol=4)
plt.savefig(cwd / 'figures' / 'supp_fig3' / 'nsclc_io_2021.pdf')
